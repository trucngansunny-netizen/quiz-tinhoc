...
app.secret_key = "replace_random_secret_key"
...
def save_detail_excel(student_name, class_name, grade, subject, filename, total, notes):
    if not os.path.exists(DETAILS_FILE):
        ...
        ws.title = "ChiTiet"
        ws.append([
            "Thời gian","Họ tên","Lớp","Khối","Môn",
            "Tên tệp","Tổng điểm","Chi tiết tiêu chí"
        ])
